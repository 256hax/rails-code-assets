...
class InboxesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create inbox" do
    assert_difference('Inbox.count') do
      post inboxes_url, params: { inbox: { body: @inbox.body, email: @inbox.email, name: @inbox.name } }
    end
  ...
  test "should update inbox" do
    patch inbox_url(@inbox), params: { inbox: { body: @inbox.body, email: @inbox.email, name: @inbox.name } }
